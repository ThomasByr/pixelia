...
ME_IMG = (
    "https://raw.githubusercontent.com/ThomasByr/useful-moderator/master/assets/images/useful-moderator.png"
)
...
FAIL_EMOJI = discord.PartialEmoji(name="cross_no", id=1135923699682398208, animated=True)
